...
module.exports = {
    ...
    ssgsveltePlugins: [
        /*
        {
            name: "@ssgsvelte/source-pageinfo"
        },
        */
        {
            name: "@ssgsvelte/source-markdown",
            options: {
                typename: "Post",
                folder: "static/posts",
